...
public class CustomCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        holder.ListID.setText(cursor.getString(cursor.getColumnIndex(DBHelper1.row_id)));
        holder.ListTitle.setText(cursor.getString(cursor.getColumnIndex(DBHelper1.row_title)));
        holder.ListDetail.setText(cursor.getString(cursor.getColumnIndex(DBHelper1.row_note)));
        holder.ListCreated.setText(cursor.getString(cursor.getColumnIndex(DBHelper1.row_created)));
    }
